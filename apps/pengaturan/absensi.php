...
if (isset($_POST['ubah_absen'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $mulai_absen_pulang = $_POST['mulai_absen_pulang'];
        $akhir_absen_pulang = $_POST['akhir_absen_pulang'];

        $sql = "update tbl_setting_absensi set
            mulai_absen='$mulai_absen',
            akhir_absen='$akhir_absen',
            mulai_absen_pulang='$mulai_absen_pulang', 
            akhir_absen_pulang='$akhir_absen_pulang'
