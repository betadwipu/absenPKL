...
session_start();
    if (isset($_POST['submit'])) {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            //Mendapatkan kode_dudi dari AJAX
            ...
            $sql="UPDATE tbl_user SET password='$password' WHERE kode_pengguna='$kode_dudi'";
...
?>
    ...
    <form action="apps/dudi/ubah_password.php" method="post">

    <div class="row">
        <div class="col-sm-7">
            <div class="form-group">
                <!-- Menyimpan kode_dudi dari AJAX -->
