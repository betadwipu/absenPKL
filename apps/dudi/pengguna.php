...
session_start();
    if (isset($_POST['submit'])) {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $kode_dudi=input($_POST["kode_dudi"]);
            ...
            if ($setting_pengguna) {
                ...
                header("Location:../../index.php?page=dudi&pengguna=berhasil");
            }
            else {
                mysqli_query($kon,"ROLLBACK");
                header("Location:../../index.php?page=dudi&pengguna=gagal");
            }
        }  
    }
?>

<form action="apps/dudi/pengguna.php" method="post">
<?php
    include '../../config/database.php';
    $kode_pengguna=$_POST['kode_dudi'];
    ...
    <div class="row">
        <div class="col-sm-7">
            <div class="form-group">
                <input name="kode_dudi" type="hidden" id="kode_dudi" class="form-control" value="<?php echo $_POST['kode_dudi'];?>"/>
            </div>
        </div>
    </div>
    <div class="row">
