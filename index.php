...
<body>
    <nav class="navbar navbar-custom navbar-fixed-top bg-info" role="navigation">
        <div class="container-fluid"><!-- container-fluid -->
            <div class="navbar-header">
                ...
                <div id="clock" style="text-align:center; font-size:25px; margin-top:10px;"></div>
            </div>
        </div><!-- /.container-fluid -->
    </nav>
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <?php if ($_SESSION['level'] == 'Pembimbing' or $_SESSION['level'] == 'Pembimbing'): ?>
            <div class="profile-sidebar">
                ...
                <div class="profile-usertitle">
                    <?php echo substr($_SESSION['nama_pembimbing'], 0, 20); ?>
                    <div class="profile-usertitle-name"><?php echo "Pembimbing"; ?></div>
                    <div></div>
                </div>
                <div class="clear"></div>
            </div>
        ...
        <?php if ($_SESSION['level'] == 'Dudi' or $_SESSION['level'] == 'Dudi'): ?>
            <div class="profile-sidebar">
                ...
                <div class="profile-usertitle">
                    <?php echo substr($_SESSION['nama_dudi'], 0, 20); ?>
                    <div class="profile-usertitle-name"><?php echo "Dudi"; ?></div>
                    <div></div>
                </div>
                <div class="clear"></div>
            </div>
    ...
    <script>
        ...
        function updateClock() {
            ...
            // Format jam yang ingin ditampilkan (misalnya 24 jam)
            var timeString = hours + ":" + minutes + ":" + seconds;

            // Update elemen HTML dengan id "clock"
        ...
        // Panggil fungsi pertama kali untuk inisialisasi jam
        updateClock();
    </script>
